...
void imprimir_numeros(int n, float numeros[]) {
    printf("{");
    for (int i = 0; i < n; i++) {
        printf("%.1f", numeros[i]);
        if (i < n-1) printf(", ");
...
int main() {
    ...
    float media = calcular_media(3, numeros1);
    printf("numeros = ");
    imprimir_numeros(3, numeros1);
    printf(", media = %.1f => %i\n", media, media == 4.0f);

    float numeros2[] = {10, 10, 10, 10};
    media = calcular_media(4, numeros2);
    printf("numeros = ");
    imprimir_numeros(4, numeros2);
    printf(", media = %.1f => %i\n", media, media == 10.0f);

    float numeros3[] = {5};
    media = calcular_media(1, numeros3);
    printf("numeros = ");
    imprimir_numeros(1, numeros3);
    printf(", media = %.1f => %i\n", media, media == 5.0f);

    float numeros4[] = {1, 2, 3, 4, 5};
    media = calcular_media(5, numeros4);
    printf("numeros = ");
    imprimir_numeros(5, numeros4);
    printf(", media = %.1f => %i\n", media, media == 3.0f);

    media = calcular_media(0, numeros4);
    printf("numeros = {} , media = %.1f => %i\n", media, media == 0.0f);
